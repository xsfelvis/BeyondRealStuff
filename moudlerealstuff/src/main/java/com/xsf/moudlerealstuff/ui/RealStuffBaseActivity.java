package com.xsf.moudlerealstuff.ui;
...
import com.xsf.moudlerealstuff.R;
...
public abstract class RealStuffBaseActivity extends AppCompatActivity{
    @Inject
    ...
    protected void initTheme() {
        boolean isNightMode = mDataManager.getTheme();
        if (isNightMode) {
